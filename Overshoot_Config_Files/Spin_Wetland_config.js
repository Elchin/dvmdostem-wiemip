{
  "general": {
    "output_global_attributes": {
        "run_name": "WIEMIP overshoot spin-up Special_spin_Wetland",
        "description": "Settings for the WIEMIP overshoot spin-up simulation Special_spin_Wetland. Input paths and the restart path will be updated by bp and other scripts."
    }
  },
  ...
  "model_settings": {
    "cell_timelimit": 172800, //Run time limit per cell in seconds. 0 for no limit.
