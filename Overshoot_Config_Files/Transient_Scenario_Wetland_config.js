{
  "general": {
    "output_global_attributes": {
        "run_name": "WIEMIP overshoot wetland run",
        "description": "Settings for the WIEMIP overshoot wetland simulations. Input paths and the restart path will be updated by bp and other scripts."
    }
  },
