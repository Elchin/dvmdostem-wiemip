{
  "general": {
    "output_global_attributes": {
        "run_name": "WIEMIP overshoot spin-up Special_spin_FireOn",
        "description": "Settings for the WIEMIP overshoot spin-up simulation Special_spin_FireOn. Input paths and the restart path will be updated by bp and other scripts."
    }
  },
