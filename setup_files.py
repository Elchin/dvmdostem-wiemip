...
def main():
    ...
    parser.add_argument(
        ...
        help="Target folder name inside /mnt/exacloud/ext_ejafarov_woodwellclimate_org/"
    )
    ...
    base_dir = "/mnt/exacloud/ext_ejafarov_woodwellclimate_org"
    ...
    mappings = [
        ...
        ("gs://wiemip/teminputs/new/wetalnd.nc", "vegetation.nc"),
